/**
 * Pulse usage: Parses NUnit XML results delivered by delivery.js.
 ...
 * Output: Method-level qTest automation logs forwarded to the submission rule.
...
exports.handler = async function ({ event: body, constants, triggers }, context, callback) {
    ...
    try {
        ...
        writeLog("INFO", "NUnit results parsed successfully.", {
            correlationId: correlationId,
            stage: "parse",
        ...
        writeLog("ERROR", "Unable to process NUnit results.", {
            correlationId: correlationId,
            stage: "failed",
        ...
        await emitEvent("ChatOpsEvent", {
            correlationId: correlationId,
            errorCode: error && error.code ? error.code : "PARSE_FAILED",
            message: `[ERROR] correlationId=${correlationId} Unable to process NUnit results: ${error.message}`,
        });
        throw error;
    }
};
