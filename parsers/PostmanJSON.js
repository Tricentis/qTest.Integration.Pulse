/**
 * Pulse usage: Parses Postman/Newman JSON results delivered by delivery.js.
...
exports.handler = async function ({ event: body, constants, triggers }, context, callback) {
    ...
    writeLog("INFO", "Postman results parsed successfully.", {
        correlationId: correlationId,
        stage: "parse",
    ...
    return formattedResults;
        ...
        writeLog("ERROR", "Unable to process Postman results.", {
            correlationId: correlationId,
            stage: "failed",
        ...
        await emitEvent("ChatOpsEvent", {
            correlationId: correlationId,
            errorCode: error && error.code ? error.code : "PARSE_FAILED",
            message: `[ERROR] correlationId=${correlationId} Unable to process Postman results: ${error.message}`,
        });
        throw error;
    }
};
